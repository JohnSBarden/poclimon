...
/// Returns `None` if the ID is not a recognized Pokémon.
pub fn lookup_name(id: u32) -> Option<&'static str> {
    FULL_DEX
        .binary_search_by_key(&id, |&(dex, _)| dex)
        .ok()
        .map(|i| FULL_DEX[i].1)
}

/// National Pokédex number → name for all Gen 1–9 Pokémon.
/// Used for Pokédex-number input — any entry here can be loaded from PMDCollab
/// (though not all IDs have complete sprites; missing animations fall back to Idle).
pub const FULL_DEX: &[(u32, &str)] = &[
    ...
    (64, "Kadabra"), (65, "Alakazam"), (66, "Machop"), (67, "Machoke"), (68, "Machamp"),
    ...
    (235, "Smeargle"), (236, "Tyrogue"), (237, "Hitmontop"), (238, "Smoochum"),
    (239, "Elekid"), (240, "Magby"), (241, "Miltank"), (242, "Blissey"),
    ...
    (371, "Bagon"), (372, "Shelgon"), (373, "Salamence"), (374, "Beldum"),
    ...
    (438, "Bonsly"), (439, "Mime Jr."), (440, "Happiny"), (441, "Chatot"),
    (442, "Spiritomb"), (443, "Gible"), (444, "Gabite"), (445, "Garchomp"),
    (446, "Munchlax"), (447, "Riolu"), (448, "Lucario"), (449, "Hippopotas"), (450, "Hippowdon"),
    (451, "Skorupi"), (452, "Drapion"), (453, "Croagunk"), (454, "Toxicroak"),
    (455, "Carnivine"), (456, "Finneon"), (457, "Lumineon"), (458, "Mantyke"),
    ...
    (557, "Dwebble"), (558, "Crustle"), (559, "Scraggy"), (560, "Scrafty"),
    ...
    (594, "Alomomola"), (595, "Joltik"), (596, "Galvantula"),
    (597, "Ferroseed"), (598, "Ferrothorn"), (599, "Klink"), (600, "Klang"), (601, "Klinklang"),
    ...
    (615, "Cryogonal"), (616, "Shelmet"), (617, "Accelgor"),
    (618, "Stunfisk"), (619, "Mienfoo"), (620, "Mienshao"),
    ...
    (659, "Bunnelby"), (660, "Diggersby"), (661, "Fletchling"), (662, "Fletchinder"), (663, "Talonflame"),
    (664, "Scatterbug"), (665, "Spewpa"), (666, "Vivillon"),
    (667, "Litleo"), (668, "Pyroar"), (669, "Flabébé"), (670, "Floette"), (671, "Florges"),
    (672, "Skiddo"), (673, "Gogoat"), (674, "Pancham"), (675, "Pangoro"),
    (676, "Furfrou"), (677, "Espurr"), (678, "Meowstic"), (679, "Honedge"), (680, "Doublade"), (681, "Aegislash"),
    ...
    (734, "Yungoos"), (735, "Gumshoos"), (736, "Grubbin"), (737, "Charjabug"), (738, "Vikavolt"),
    (739, "Crabrawler"), (740, "Crabominable"), (741, "Oricorio"), (742, "Cutiefly"), (743, "Ribombee"),
    (744, "Rockruff"), (745, "Lycanroc"), (746, "Wishiwashi"), (747, "Mareanie"), (748, "Toxapex"),
    (749, "Mudbray"), (750, "Mudsdale"), (751, "Dewpider"), (752, "Araquanid"),
    ...
    (764, "Comfey"), (765, "Oranguru"), (766, "Passimian"), (767, "Wimpod"), (768, "Golisopod"),
    (769, "Sandygast"), (770, "Palossand"), (771, "Pyukumuku"), (772, "Type: Null"), (773, "Silvally"),
    (774, "Minior"), (775, "Komala"), (776, "Turtonator"), (777, "Togedemaru"), (778, "Mimikyu"),
    (779, "Bruxish"), (780, "Drampa"), (781, "Dhelmise"), (782, "Jangmo-o"), (783, "Hakamo-o"), (784, "Kommo-o"),
    ...
    (803, "Poipole"), (804, "Naganadel"), (805, "Stakataka"), (806, "Blacephalon"), (807, "Zeraora"),
    ...
    (831, "Wooloo"), (832, "Dubwool"), (833, "Chewtle"), (834, "Drednaw"),
    ...
    (899, "Wyrdeer"), (900, "Kleavor"), (901, "Ursaluna"), (902, "Basculegion"),
    (903, "Sneasler"), (904, "Overqwil"), (905, "Enamorus"),
    // Gen 9 (906–1025)
    (906, "Sprigatito"), (907, "Floragato"), (908, "Meowscarada"),
    (909, "Fuecoco"), (910, "Crocalor"), (911, "Skeledirge"),
    (912, "Quaxly"), (913, "Quaxwell"), (914, "Quaquaval"),
    (915, "Lechonk"), (916, "Oinkologne"), (917, "Tarountula"), (918, "Spidops"),
    (919, "Nymble"), (920, "Lokix"), (921, "Pawmi"), (922, "Pawmo"), (923, "Pawmot"),
    (924, "Tandemaus"), (925, "Maushold"), (926, "Fidough"), (927, "Dachsbun"),
    (928, "Smoliv"), (929, "Dolliv"), (930, "Arboliva"),
    (931, "Squawkabilly"), (932, "Nacli"), (933, "Naclstack"), (934, "Garganacl"),
    ...
    (953, "Rellor"), (954, "Rabsca"), (955, "Flittle"), (956, "Espathra"),
    (957, "Tinkatink"), (958, "Tinkatuff"), (959, "Tinkaton"),
    (960, "Wiglett"), (961, "Wugtrio"), (962, "Bombirdier"),
    (963, "Finizen"), (964, "Palafin"), (965, "Varoom"), (966, "Revavroom"),
    (967, "Cyclizar"), (968, "Orthworm"), (969, "Glimmet"), (970, "Glimmora"),
    (971, "Greavard"), (972, "Houndstone"), (973, "Flamigo"), (974, "Cetoddle"), (975, "Cetitan"),
    (976, "Veluza"), (977, "Dondozo"), (978, "Tatsugiri"), (979, "Annihilape"),
    (980, "Clodsire"), (981, "Farigiraf"), (982, "Dudunsparce"), (983, "Kingambit"),
...
mod tests {
    ...
    #[test]
    fn test_full_dex_lookup() {
        assert_eq!(lookup_name(25), Some("Pikachu"));
        assert_eq!(lookup_name(150), Some("Mewtwo"));
        assert_eq!(lookup_name(1), Some("Bulbasaur"));
        assert!(lookup_name(9999).is_none());
    }
}
